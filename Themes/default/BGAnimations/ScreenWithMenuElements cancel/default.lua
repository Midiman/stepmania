...
local t = Def.ActorFrame {
	...
	Def.Quad {
		...
		StartTransitioningCommand=cmd(diffuse,Color.Black;diffusealpha,0;decelerate,0.125;diffusealpha,1);
	}
};
...
t[#t+1] = Def.ActorFrame {
	InitCommand=cmd(x,SCREEN_WIDTH-32;y,SCREEN_HEIGHT-32;pulse;effectmagnitude,1,1.25,0;effectclock,'timerglobal';effectperiod,0.45),
	OnCommand=cmd(sleep,fSleepTime),
	--
	LoadActor(THEME:GetPathG("Player","Badge FullCombo")) .. {
		StartTransitioningCommand=cmd(diffuse,Color.Yellow;zoom,0;diffusealpha,0;linear,0.1;zoom,1;diffusealpha,1)
	}
};
